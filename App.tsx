...
import { ArrowRight, RotateCcw, Play, PlusCircle, PenTool, MapPin, AlertCircle, Building2 } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <ConfirmationModal 
        ...
        message="This will clear your current profile details and action plan."
      />
